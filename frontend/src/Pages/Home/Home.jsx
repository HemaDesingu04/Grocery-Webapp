          ...
          <div className="main-home">
            <section className="home">
              <div className="content">
                <h3>
                <span>Fresh, Organic, and Affordable</span>Bringing the Best of Local Groceries to Your Doorstep!
                </h3>
                <p>
                Handpicked fresh produce and organic essentials for your family. Supporting local farms and providing you with the finest, farm-to-table ingredients. Get the best of nature at prices that won’t break your budget.
                </p>
                <Link to="/products">
                  {" "}
            ...
            <div className="box-container">
              <div className="box">
                ...
                <p>
                  ...
                  Delivering Grocery Products Well. We Have The
              ...
              <div className="box">
                ...
                <p>
                  {" "}
                  We Are Doing FREE Shipping All Over India. Add Your Favorite
